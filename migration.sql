-- ════════════════════════════════════════════════════════
-- Activum Academy — Migración de courseData.js a Supabase
-- Generado: 2026-04-07T15:52:27.234Z
-- ════════════════════════════════════════════════════════

BEGIN;

-- ── Cursos (desde catalogData.js) ──────────────────────
INSERT INTO courses (id, title, subtitle, description, category, level, duration, total_modules, total_lessons, status, type, badge, topics)
VALUES (
  'tokenizacion-inmobiliaria',
  'Tokenizacion de Activos Inmobiliarios en Espana',
  'De los Fundamentos a la Practica',
  'Aprende todo sobre tokenizacion inmobiliaria: tecnologia blockchain, marco legal espanol (MiCA, CNMV), modelos de negocio y casos de uso reales en el mercado espanol.',
  'PropTech',
  'Intermedio',
  '8 horas',
  11,
  ...
  'public',
  'Nuevo',
  '["Blockchain","Smart Contracts","MiCA","Regulacion CNMV","Casos de Uso","Mercado Espanol"]'::jsonb
  ...
  badge = EXCLUDED.badge, topics = EXCLUDED.topics,
  updated_at = now();

INSERT INTO courses (id, title, subtitle, description, category, level, duration, total_modules, total_lessons, status, type, badge, topics)
VALUES (
  'inteligencia-artificial-real-estate',
  'Inteligencia Artificial aplicada al Real Estate',
  'Automatizacion, valoracion y captacion con IA',
  'Domina las herramientas de IA mas relevantes para el sector inmobiliario: automatizacion de captacion, valoracion automatica de activos, IA conversacional y analisis de mercado.',
  'PropTech',
  'Basico - Intermedio',
  '6 horas',
  9,
  ...
  'public',
  'Proximo',
  '["Agentes de IA","Valoracion AVM","CRM Inteligente","Automatizacion","ChatGPT para Inmobiliario"]'::jsonb
) ON CONFLICT (id) DO UPDATE SET
  title = EXCLUDED.title, subtitle = EXCLUDED.subtitle,
  description = EXCLUDED.description, category = EXCLUDED.category,
  level = EXCLUDED.level, duration = EXCLUDED.duration,
...
INSERT INTO courses (id, title, subtitle, description, category, level, duration, total_modules, total_lessons, status, type, badge, topics)
VALUES (
  'flex-living-modelo-negocio',
  'Flex-Living: El Nuevo Modelo de Negocio Residencial',
  'Coliving, BTR, PBSA y Senior Living',
  'Analisis profundo del sector flex-living en Espana y Europa: modelos de gestion, estructura financiera, captacion de inversores y casos de exito de los operadores lideres.',
  'Real Estate',
  'Avanzado',
  '7 horas',
  10,
  ...
  'public',
  'Proximo',
  '["Coliving","BTR","PBSA","Senior Living","Gestion de Activos","Estructura Financiera"]'::jsonb
) ON CONFLICT (id) DO UPDATE SET
  title = EXCLUDED.title, subtitle = EXCLUDED.subtitle,
  description = EXCLUDED.description, category = EXCLUDED.category,
  level = EXCLUDED.level, duration = EXCLUDED.duration,
...
VALUES (
  ...
  'Inversion Inmobiliaria en Espana',
  'Analisis, valoracion y estrategia de cartera',
  'Curso completo para inversores que quieren entender el mercado inmobiliario espanol: analisis de mercado, valoracion de activos, fiscalidad, financiacion y construccion de cartera.',
  'Inversion',
  'Basico - Intermedio',
  '9 horas',
  12,
  ...
  'public',
  'Proximo',
  '["Analisis de Mercado","Valoracion","Fiscalidad","Financiacion","Cartera","SOCIMIs"]'::jsonb
) ON CONFLICT (id) DO UPDATE SET
  title = EXCLUDED.title, subtitle = EXCLUDED.subtitle,
  description = EXCLUDED.description, category = EXCLUDED.category,
  level = EXCLUDED.level, duration = EXCLUDED.duration,
...
-- ── Módulos, lecciones y quizzes (tokenizacion-inmobiliaria) ──

-- Módulo 1: Introducción y Bienvenida
INSERT INTO modules (id, course_id, title, position)
VALUES ('0343b675-079c-48d2-a449-78e35f829043', 'tokenizacion-inmobiliaria', 'Introducción y Bienvenida', 0)
ON CONFLICT DO NOTHING;

INSERT INTO lessons (id, module_id, course_id, title, duration, content, position)
VALUES (
  '0-1',
  '0343b675-079c-48d2-a449-78e35f829043',
  'tokenizacion-inmobiliaria',
...
INSERT INTO quiz_questions (module_id, course_id, question, options, correct_answer, position)
VALUES (
  '0343b675-079c-48d2-a449-78e35f829043',
  'tokenizacion-inmobiliaria',
  '¿Cuál es el nivel requerido para este curso?',
  '["Experto en blockchain","Intermedio, con conocimientos básicos del sector","Sin conocimientos previos necesarios","Solo para desarrolladores técnicos"]'::jsonb,
  1,
  0
);
...
VALUES (
  ...
  '["Un contrato notarial digitalizado","Código que se ejecuta automáticamente cuando se cumplen condiciones","Una criptomoneda vinculada a un inmueble","Un sistema de firma electrónica"]'::jsonb,
  1,
  1
);
...
VALUES (
  ...
  'tokenizacion-inmobiliaria',
  '¿Qué significa MiCA?',
  '["Mercado Inmobiliario Cripto Avanzado","Markets in Crypto-Assets — reglamento europeo","Módulo de Inversión en Criptoactivos","Marco de Integración de Criptoactivos"]'::jsonb,
  1,
  2
);

-- Módulo 2: Fundamentos del Sector Inmobiliario
INSERT INTO modules (id, course_id, title, position)
VALUES ('7d876253-7a50-42eb-8d6d-0bdbd4e2eb07', 'tokenizacion-inmobiliaria', 'Fundamentos del Sector Inmobiliario', 1)
ON CONFLICT DO NOTHING;

INSERT INTO lessons (id, module_id, course_id, title, duration, content, position)
VALUES (
  '1-1',
  '7d876253-7a50-42eb-8d6d-0bdbd4e2eb07',
  'tokenizacion-inmobiliaria',
...
VALUES (
  ...
  '7d876253-7a50-42eb-8d6d-0bdbd4e2eb07',
  'tokenizacion-inmobiliaria',
  'Barreras de la inversión tradicional',
  '10 min',
  '
...
VALUES (
  '7d876253-7a50-42eb-8d6d-0bdbd4e2eb07',
  'tokenizacion-inmobiliaria',
  '¿Cuál es la principal limitación de las SOCIMIs como vehículo de inversión?',
  '["Su alta tributación","La pérdida de exposición directa a activos concretos","El precio demasiado bajo de las acciones","Que solo invierten en oficinas"]'::jsonb,
  1,
  0
);
...
VALUES (
  '7d876253-7a50-42eb-8d6d-0bdbd4e2eb07',
  'tokenizacion-inmobiliaria',
  '¿Cuánto representa el sector inmobiliario aproximadamente en el PIB español?',
  '["3%","20%","10%","35%"]'::jsonb,
  2,
  1
);
...
VALUES (
  '7d876253-7a50-42eb-8d6d-0bdbd4e2eb07',
  'tokenizacion-inmobiliaria',
  '¿Qué es el ''fraccionamiento'' en el contexto de la tokenización?',
  '["Dividir un inmueble físicamente en partes","Representar un activo en múltiples tokens de menor valor","Un tipo de hipoteca parcial","La venta de inmuebles por habitaciones"]'::jsonb,
  1,
  2
);
...
VALUES (
  '7d876253-7a50-42eb-8d6d-0bdbd4e2eb07',
  'tokenizacion-inmobiliaria',
  '¿Qué coste tiene aproximadamente el ITP en una compraventa de segunda mano en España?',
  '["0,5-1%","2-3%","6-10%","15-20%"]'::jsonb,
  2,
  3
);

-- Módulo 3: Definiciones y Conceptos Clave
INSERT INTO modules (id, course_id, title, position)
VALUES ('7cef16bd-3d65-41bb-86e3-24503b49415a', 'tokenizacion-inmobiliaria', 'Definiciones y Conceptos Clave', 2)
ON CONFLICT DO NOTHING;

INSERT INTO lessons (id, module_id, course_id, title, duration, content, position)
VALUES (
  '2-1',
  '7cef16bd-3d65-41bb-86e3-24503b49415a',
  'tokenizacion-inmobiliaria',
...
VALUES (
  ...
  '7cef16bd-3d65-41bb-86e3-24503b49415a',
  'tokenizacion-inmobiliaria',
  'Tipos de tokens en el sector inmobiliario',
  '15 min',
  '
...
VALUES (
  '7cef16bd-3d65-41bb-86e3-24503b49415a',
  'tokenizacion-inmobiliaria',
  '¿Cuál es la diferencia fundamental entre tokenización y digitalización de un activo?',
  '["No hay diferencia, son sinónimos","La tokenización representa derechos en blockchain; la digitalización es simplemente convertir documentos a formato digital","La tokenización es más barata","La digitalización requiere blockchain"]'::jsonb,
  1,
  0
);
...
VALUES (
  '7cef16bd-3d65-41bb-86e3-24503b49415a',
  'tokenizacion-inmobiliaria',
  '¿Qué tipo de token es el más relevante para la inversión inmobiliaria?',
  '["Utility Token","NFT inmobiliario","Security Token","Stablecoin"]'::jsonb,
  2,
  1
);
...
VALUES (
  '7cef16bd-3d65-41bb-86e3-24503b49415a',
  'tokenizacion-inmobiliaria',
  '¿Para qué se utilizan las stablecoins en transacciones inmobiliarias tokenizadas?',
  '["Para representar la propiedad del inmueble","Como moneda de liquidación sin volatilidad de precio","Para registrar el inmueble en blockchain","Para hacer auditorías de smart contracts"]'::jsonb,
  1,
  2
);

-- Módulo 4: Tecnología: Cómo Funciona
INSERT INTO modules (id, course_id, title, position)
VALUES ('e1720dc6-d25d-45d2-bd8f-389c57ea55d6', 'tokenizacion-inmobiliaria', 'Tecnología: Cómo Funciona', 3)
ON CONFLICT DO NOTHING;

INSERT INTO lessons (id, module_id, course_id, title, duration, content, position)
VALUES (
  '3-1',
  'e1720dc6-d25d-45d2-bd8f-389c57ea55d6',
  'tokenizacion-inmobiliaria',
  'Blockchain aplicada al sector inmobiliario',
  '15 min',
  '
...
VALUES (
  ...
  'e1720dc6-d25d-45d2-bd8f-389c57ea55d6',
  'tokenizacion-inmobiliaria',
  'Smart Contracts: el motor de la tokenización',
  '15 min',
  '
...
VALUES (
  ...
  'e1720dc6-d25d-45d2-bd8f-389c57ea55d6',
  'tokenizacion-inmobiliaria',
  'Redes blockchain y estándares de tokens',
  '12 min',
  '
...
VALUES (
  'e1720dc6-d25d-45d2-bd8f-389c57ea55d6',
  'tokenizacion-inmobiliaria',
  '¿Qué estándar de token es el más utilizado para Security Tokens con cumplimiento normativo integrado?',
  '["ERC-20","ERC-721 (NFT)","ERC-3643 (T-REX)","BEP-20"]'::jsonb,
  2,
  0
);
...
VALUES (
  'e1720dc6-d25d-45d2-bd8f-389c57ea55d6',
  'tokenizacion-inmobiliaria',
  '¿Cuál es ''el problema del oráculo'' en smart contracts?',
  '["Los contratos son demasiado lentos","Los smart contracts no tienen acceso nativo a datos del mundo real","Los oráculos son empresas que cobran demasiado","Solo funciona en Ethereum"]'::jsonb,
  1,
  1
);
...
VALUES (
  'e1720dc6-d25d-45d2-bd8f-389c57ea55d6',
  'tokenizacion-inmobiliaria',
  '¿Qué diferencia principal tiene una blockchain privada frente a una pública?',
  '["Es más cara","Solo acceden participantes autorizados, mayor velocidad pero menor descentralización","No puede usar smart contracts","Está prohibida en Europa"]'::jsonb,
  1,
  2
);

-- Módulo 5: Regulación y Marco Legal
INSERT INTO modules (id, course_id, title, position)
VALUES ('667343fb-a807-49c6-b531-5d9bb4a8d274', 'tokenizacion-inmobiliaria', 'Regulación y Marco Legal', 4)
ON CONFLICT DO NOTHING;

INSERT INTO lessons (id, module_id, course_id, title, duration, content, position)
VALUES (
  '4-1',
  '667343fb-a807-49c6-b531-5d9bb4a8d274',
  'tokenizacion-inmobiliaria',
  'MiCA: El reglamento europeo de criptoactivos',
  '18 min',
  '
...
VALUES (
  ...
  '667343fb-a807-49c6-b531-5d9bb4a8d274',
  'tokenizacion-inmobiliaria',
  'Marco legal en España: CNMV y LMV',
  '15 min',
  '
...
VALUES (
  ...
  '667343fb-a807-49c6-b531-5d9bb4a8d274',
  'tokenizacion-inmobiliaria',
  'KYC, AML y protección del inversor',
  '10 min',
  '
...
VALUES (
  '667343fb-a807-49c6-b531-5d9bb4a8d274',
  'tokenizacion-inmobiliaria',
  '¿Los Security Tokens inmobiliarios están cubiertos por MiCA?',
  '["Sí, es la regulación principal que los cubre","No, están excluidos de MiCA y se rigen por las directivas de mercados de valores (MiFID II)","Solo parcialmente, los de menos de 1M€","Sí, pero solo desde 2025"]'::jsonb,
  1,
  0
);
...
VALUES (
  '667343fb-a807-49c6-b531-5d9bb4a8d274',
  'tokenizacion-inmobiliaria',
  '¿A partir de qué umbral de emisión en España se requiere un prospecto completo aprobado por la CNMV?',
  '["500.000€","1M€","5M€","10M€"]'::jsonb,
  2,
  1
);
...
VALUES (
  '667343fb-a807-49c6-b531-5d9bb4a8d274',
  'tokenizacion-inmobiliaria',
  '¿Qué es el Modelo 721 en España?',
  '["El formulario para crear una SOCIMI","La declaración obligatoria de criptoactivos en el extranjero que superen 50.000€","El impuesto sobre transmisiones de tokens","El registro de plataformas de tokenización ante la CNMV"]'::jsonb,
  1,
  2
);

-- Módulo 6: Modelos de Negocio y Casos de Uso
INSERT INTO modules (id, course_id, title, position)
VALUES ('7cae0a6e-2197-41c6-9bda-499fe1332476', 'tokenizacion-inmobiliaria', 'Modelos de Negocio y Casos de Uso', 5)
ON CONFLICT DO NOTHING;

INSERT INTO lessons (id, module_id, course_id, title, duration, content, position)
VALUES (
  '5-1',
  '7cae0a6e-2197-41c6-9bda-499fe1332476',
  'tokenizacion-inmobiliaria',
  'Inversión fraccionada en residencial',
  '12 min',
  '
...
VALUES (
  ...
  '7cae0a6e-2197-41c6-9bda-499fe1332476',
  'tokenizacion-inmobiliaria',
  'Financiación de promotoras con tokens',
  '12 min',
  '
...
VALUES (
  ...
  '7cae0a6e-2197-41c6-9bda-499fe1332476',
  'tokenizacion-inmobiliaria',
  'Flex-living y activos alternativos tokenizados',
  '10 min',
  '
...
VALUES (
  '7cae0a6e-2197-41c6-9bda-499fe1332476',
  'tokenizacion-inmobiliaria',
  '¿Cuál es el principal riesgo de la inversión fraccionada vía tokens para el inversor retail?',
  '["Que el inmueble se destruya","La falta de liquidez en el mercado secundario","Que los tokens suban mucho de valor","La excesiva regulación"]'::jsonb,
  1,
  0
);
...
VALUES (
  '7cae0a6e-2197-41c6-9bda-499fe1332476',
  'tokenizacion-inmobiliaria',
  '¿Por qué los activos de flex-living encajan especialmente bien con la tokenización?',
  '["Porque son muy baratos","Por su gestión profesionalizada, rentas estables y mayor valor unitario","Porque no requieren regulación","Porque son activos físicamente divisibles"]'::jsonb,
  1,
  1
);
...
VALUES (
  '7cae0a6e-2197-41c6-9bda-499fe1332476',
  'tokenizacion-inmobiliaria',
  '¿Qué ventaja tiene la deuda tokenizada frente al crowdfunding inmobiliario tradicional?',
  '["No hay diferencias relevantes","Los tokens son potencialmente transferibles en mercado secundario","Es más barata para la promotora","No requiere KYC"]'::jsonb,
  1,
  2
);

-- Módulo 7: Plataformas y Ecosistema
INSERT INTO modules (id, course_id, title, position)
VALUES ('95c86504-ebac-46e2-b18e-ae33cce2aa37', 'tokenizacion-inmobiliaria', 'Plataformas y Ecosistema', 6)
ON CONFLICT DO NOTHING;

INSERT INTO lessons (id, module_id, course_id, title, duration, content, position)
VALUES (
  '6-1',
  '95c86504-ebac-46e2-b18e-ae33cce2aa37',
  'tokenizacion-inmobiliaria',
  'Ecosistema global de tokenización inmobiliaria',
  '12 min',
  '
...
VALUES (
  ...
  '95c86504-ebac-46e2-b18e-ae33cce2aa37',
  'tokenizacion-inmobiliaria',
  'Checklist del inversor: cómo evaluar una plataforma',
  '10 min',
  '
...
VALUES (
  '95c86504-ebac-46e2-b18e-ae33cce2aa37',
  'tokenizacion-inmobiliaria',
  '¿Qué empresa española es líder en infraestructura de emisión de tokens inmobiliarios?',
  '["Metrovacesa","Brickken","Merlin Properties","Idealista"]'::jsonb,
  1,
  0
);
...
VALUES (
  '95c86504-ebac-46e2-b18e-ae33cce2aa37',
  'tokenizacion-inmobiliaria',
  '¿Cuál es la primera pregunta clave en la due diligence de una plataforma de tokenización?',
  '["Si tienen app móvil","Si están registradas ante el regulador pertinente","Si el logo es bonito","Si tienen oficina en Madrid"]'::jsonb,
  1,
  1
);
...
VALUES (
  ...
  'tokenizacion-inmobiliaria',
  '¿Qué es SDX?',
  '["Un token español de real estate","SIX Digital Exchange — uno de los mercados secundarios de Security Tokens más avanzados de Europa","Una stablecoin del Banco Santander","Un estándar técnico de blockchain"]'::jsonb,
  1,
  2
);

-- Módulo 8: Casos de Éxito y Análisis
INSERT INTO modules (id, course_id, title, position)
VALUES ('5dfdaee2-90a6-49c1-9bfb-c3da465fc4cb', 'tokenizacion-inmobiliaria', 'Casos de Éxito y Análisis', 7)
ON CONFLICT DO NOTHING;

INSERT INTO lessons (id, module_id, course_id, title, duration, content, position)
VALUES (
  '7-1',
  '5dfdaee2-90a6-49c1-9bfb-c3da465fc4cb',
  'tokenizacion-inmobiliaria',
  'Caso 1: Edificio residencial tokenizado en Madrid',
  '15 min',
  '
...
VALUES (
  ...
  '5dfdaee2-90a6-49c1-9bfb-c3da465fc4cb',
  'tokenizacion-inmobiliaria',
  'Caso 2: Deuda tokenizada para promotora',
  '12 min',
  '
...
VALUES (
  ...
  '5dfdaee2-90a6-49c1-9bfb-c3da465fc4cb',
  'tokenizacion-inmobiliaria',
  'Caso 3: Fracasos y señales de alerta',
  '10 min',
  '
...
VALUES (
  '5dfdaee2-90a6-49c1-9bfb-c3da465fc4cb',
  'tokenizacion-inmobiliaria',
  '¿Cuánto representaron los costes de estructuración en el caso del edificio de Chamberí?',
  '["0,5% del volumen","2,5% del volumen total","10% del volumen","15% del volumen"]'::jsonb,
  1,
  0
);
...
VALUES (
  '5dfdaee2-90a6-49c1-9bfb-c3da465fc4cb',
  'tokenizacion-inmobiliaria',
  '¿Cuál fue el beneficio operativo más destacado en el caso de la promotora de Málaga?',
  '["Que el banco les financió más","El pago automático a 554 inversores en menos de 1 hora vía smart contract","Que los pisos se alquilaron más caros","Que no necesitaron notario"]'::jsonb,
  1,
  1
);
...
VALUES (
  '5dfdaee2-90a6-49c1-9bfb-c3da465fc4cb',
  'tokenizacion-inmobiliaria',
  '¿Cuál es una señal de alerta clara ante una plataforma de tokenización?',
  '["Que tengan oficina en Madrid","Promesas de rentabilidad garantizada superiores al 15% anual","Que usen Ethereum","Que pidan KYC antes de invertir"]'::jsonb,
  1,
  2
);

-- Módulo 9: Riesgos y Desafíos
INSERT INTO modules (id, course_id, title, position)
VALUES ('602ddde0-f3f2-42fc-82ec-ac98bfb32fd2', 'tokenizacion-inmobiliaria', 'Riesgos y Desafíos', 8)
ON CONFLICT DO NOTHING;

INSERT INTO lessons (id, module_id, course_id, title, duration, content, position)
VALUES (
  '8-1',
  '602ddde0-f3f2-42fc-82ec-ac98bfb32fd2',
  'tokenizacion-inmobiliaria',
...
VALUES (
  ...
  '602ddde0-f3f2-42fc-82ec-ac98bfb32fd2',
  'tokenizacion-inmobiliaria',
  'Riesgos legales y expectativas calibradas',
  '10 min',
  '
...
VALUES (
  '602ddde0-f3f2-42fc-82ec-ac98bfb32fd2',
  'tokenizacion-inmobiliaria',
  '¿Qué debe garantizar la estructura legal de un SPV en caso de quiebra de la plataforma?',
  '["Que los fundadores recuperen su dinero primero","Que los tokens sigan siendo jurídicamente válidos independientemente de la plataforma","Que el activo pase al Estado","Que los tokens sean reembolsados automáticamente"]'::jsonb,
  1,
  0
);
...
VALUES (
  '602ddde0-f3f2-42fc-82ec-ac98bfb32fd2',
  'tokenizacion-inmobiliaria',
  '¿Cuál es el umbral mínimo de activo aproximado para que la tokenización sea económicamente eficiente?',
  '["10.000€","100.000€","1-2M€","50M€"]'::jsonb,
  2,
  1
);

-- Módulo 10: El Futuro de la Tokenización
INSERT INTO modules (id, course_id, title, position)
VALUES ('d837427f-c172-488e-b5eb-00beb5115314', 'tokenizacion-inmobiliaria', 'El Futuro de la Tokenización', 9)
ON CONFLICT DO NOTHING;

INSERT INTO lessons (id, module_id, course_id, title, duration, content, position)
VALUES (
  '9-1',
  'd837427f-c172-488e-b5eb-00beb5115314',
  'tokenizacion-inmobiliaria',
  'RWA: La tokenización institucional despega',
  '15 min',
  '
...
VALUES (
  ...
  'd837427f-c172-488e-b5eb-00beb5115314',
  'tokenizacion-inmobiliaria',
  'España como hub europeo de tokenización',
  '12 min',
  '
...
VALUES (
  'd837427f-c172-488e-b5eb-00beb5115314',
  'tokenizacion-inmobiliaria',
  '¿Qué empresa lanzó el fondo tokenizado BUIDL en 2024, legitimando la tokenización institucional?',
  '["Goldman Sachs","BlackRock","JPMorgan","Vanguard"]'::jsonb,
  1,
  0
);
...
VALUES (
  'd837427f-c172-488e-b5eb-00beb5115314',
  'tokenizacion-inmobiliaria',
  '¿Cuál es una ventaja competitiva clave de España para la tokenización inmobiliaria?',
  '["Que tiene la regulación más permisiva de Europa","Su conexión natural con LATAM como puente de inversión","Que no tiene impuestos sobre tokens","Que Bitcoin es moneda de curso legal"]'::jsonb,
  1,
  1
);
...
VALUES (
  'd837427f-c172-488e-b5eb-00beb5115314',
  'tokenizacion-inmobiliaria',
  '¿Qué proyección hace BCG para el mercado total de RWA tokenizados en 2030?',
  '["500 millones de dólares","50.000 millones de dólares","16 billones de dólares","1 billón de dólares"]'::jsonb,
  2,
  2
);
...
INSERT INTO modules (id, course_id, title, position)
VALUES ('b44e5aaa-4b62-4d24-b99b-06c6a7442231', 'tokenizacion-inmobiliaria', 'Proyecto Final y Certificación', 10)
ON CONFLICT DO NOTHING;

INSERT INTO lessons (id, module_id, course_id, title, duration, content, position)
VALUES (
  '10-1',
  'b44e5aaa-4b62-4d24-b99b-06c6a7442231',
  'tokenizacion-inmobiliaria',
...
VALUES (
  'b44e5aaa-4b62-4d24-b99b-06c6a7442231',
  'tokenizacion-inmobiliaria',
  '¿Cuántos componentes tiene el entregable del proyecto final?',
  '["3","5","8","12"]'::jsonb,
  2,
  0
);
...
VALUES (
  'b44e5aaa-4b62-4d24-b99b-06c6a7442231',
  'tokenizacion-inmobiliaria',
  '¿Dónde puedes encontrar el whitepaper ''The Token Economy'' de Shermin Voshmgir?',
  '["Solo en formato físico en librerías","Online gratuitamente en Open Access","Solo disponible para alumnos de MIT","Es un documento confidencial del CNMV"]'::jsonb,
  1,
  1
);
