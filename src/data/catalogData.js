export const catalogData = [
  ...
  {
    id: 'flex-living-espana',
    type: 'public',
    title: 'Flex Living en España: Modelo de Negocio y Mercado',
    subtitle: 'Del Coliving al Corporate Housing — Guía Completa',
    description: 'Domina el modelo de negocio del Flex Living en España: tipologías, regulación, perfil del residente, estructura financiera y outlook de mercado. Formación especializada para operadores, inversores y equipos comerciales.',
    category: 'Real Estate',
    level: 'Intermedio',
    duration: '5 horas',
    modules: 8,
    ...
    status: 'published',
    badge: 'Nuevo',
    topics: ['Flex Living', 'Coliving', 'Regulacion', 'Mercado España', 'Perfil Residente', 'IVA Alojamiento'],
  },
  {
