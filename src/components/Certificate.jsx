    ...
    <div className="flex flex-col h-full bg-act-beige1">
      ...
      <div className="flex-1 overflow-y-auto p-8 flex items-start justify-center">
        <div className="w-full max-w-3xl bg-act-white shadow-card-hover animate-fade-in" style={{
          padding: '56px 64px', fontFamily: 'DM Sans, sans-serif',
          ...
          <div>
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:'28px' }}>
              <div style={{ display:'flex', alignItems:'center', gap:'10px' }}>
                ...
                <div>
                  <div style={{ fontFamily:'Cormorant Garamond,serif', fontSize:'13px', letterSpacing:'0.14em', color:'#1E1D16', fontWeight:600 }}>ACTIVUM</div>
                  <div style={{ fontSize:'8px', letterSpacing:'0.22em', color:'#8C1736', textTransform:'uppercase' }}>Academy</div>
                </div>
              </div>
              <div style={{ textAlign:'right' }}>
                <div style={{ fontSize:'8px', letterSpacing:'0.15em', color:'#8C1736', textTransform:'uppercase', marginBottom:'2px' }}>Puntuacion media</div>
                <div style={{ fontFamily:'Cormorant Garamond,serif', fontSize:'26px', fontWeight:500, color:'#1E1D16' }}>{avgScore}%</div>
              </div>
            </div>
            <div style={{ textAlign:'center', marginBottom:'16px' }}>
              <div style={{ fontSize:'8px', letterSpacing:'0.25em', color:'#8C1736', textTransform:'uppercase', marginBottom:'6px' }}>Certificado de Finalizacion</div>
              <div style={{ fontFamily:'Cormorant Garamond,serif', fontSize:'12px', color:'#5a5347' }}>Este certificado acredita que</div>
            </div>
            <div style={{ textAlign:'center', marginBottom:'16px' }}>
              <div style={{ fontFamily:'Cormorant Garamond,serif', fontSize:'40px', fontWeight:400, fontStyle:'italic', color:'#1E1D16', lineHeight:1.1, borderBottom:'1px solid rgba(140,23,54,0.3)', paddingBottom:'10px', marginBottom:'8px' }}>
                {customName}
              </div>
              <div style={{ fontFamily:'Cormorant Garamond,serif', fontSize:'12px', color:'#5a5347' }}>ha completado satisfactoriamente el curso</div>
            </div>
            <div style={{ textAlign:'center' }}>
              <div style={{ fontFamily:'Cormorant Garamond,serif', fontSize:'20px', fontWeight:600, color:'#1E1D16', letterSpacing:'0.01em', lineHeight:1.2 }}>
                Tokenizacion de Activos Inmobiliarios en Espana
              </div>
              <div style={{ fontFamily:'Cormorant Garamond,serif', fontSize:'13px', color:'#8C1736', fontStyle:'italic', marginTop:'4px' }}>
          ...
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-end' }}>
            <div>
              <div style={{ fontSize:'8px', letterSpacing:'0.15em', textTransform:'uppercase', color:'#8C1736', marginBottom:'2px' }}>Emitido el</div>
              <div style={{ fontFamily:'Cormorant Garamond,serif', fontSize:'12px', color:'#1E1D16' }}>{today}</div>
            </div>
            <div style={{ textAlign:'center' }}>
              <div style={{ fontFamily:'Cormorant Garamond,serif', fontStyle:'italic', fontSize:'16px', color:'#1E1D16', borderBottom:'1px solid #1E1D16', paddingBottom:'2px', marginBottom:'4px' }}>Activum Academy</div>
              <div style={{ fontSize:'7px', letterSpacing:'0.12em', color:'#9CA3AF', textTransform:'uppercase' }}>Direccion Academica</div>
            </div>
            <div style={{ textAlign:'right' }}>
              <div style={{ fontSize:'8px', letterSpacing:'0.15em', textTransform:'uppercase', color:'#8C1736', marginBottom:'2px' }}>Duracion</div>
              <div style={{ fontFamily:'Cormorant Garamond,serif', fontSize:'12px', color:'#1E1D16' }}>8 horas lectivas</div>
            </div>
          </div>
        </div>
      </div>
